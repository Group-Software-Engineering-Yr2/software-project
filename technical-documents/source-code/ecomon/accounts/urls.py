...
from .views import UserProfileView, UpdateProfileView, RegisterView, LoginView, render_privacy, render_sign_up, render_login, UpdateEmailView, UpdatePasswordView, UpdateUsernameView
